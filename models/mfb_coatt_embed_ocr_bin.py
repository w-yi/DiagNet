...
#JOINT_EMB_SIZE
class mfb_coatt_embed_ocr_bin(nn.Module):
    def __init__(self, opt):
        super(mfb_coatt_embed_ocr_bin, self).__init__()
        self.opt = opt
        ...
        self.Linear_predict1 = nn.Linear(opt.MFB_OUT_DIM*2, opt.MAX_ANSWER_VOCAB_SIZE)
        self.Linear_predict2 = nn.Linear(opt.MFB_OUT_DIM*2, opt.MAX_TOKEN_SIZE)
