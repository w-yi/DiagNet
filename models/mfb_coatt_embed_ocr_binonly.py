...
#JOINT_EMB_SIZE
class mfb_coatt_embed_ocr_binonly(nn.Module):
    def __init__(self, opt):
        super(mfb_coatt_embed_ocr_binonly, self).__init__()
        self.opt = opt
        ...
        self.Linear_predict = nn.Linear(opt.MFB_OUT_DIM*2, 1)
    ...
    def forward(self, data, img_feature, glove, cvec_token, token_embedding, mode):
        ...
        prediction = self.Linear_predict(torch.cat((mfb_l2, mfb_l2_), 1))
